    ...
    <div class='container'>
        <aside style='width: 20%;border: 2px solid #00e87b;border-radius: 5px 0px 0px 5px;float: left;margin-top: 40px;padding: 20px;height: 114px;'>
            <ul style='list-style-type: none;'>
                ...
                <li><a href='#' style='text-decoration: none;color: black;'>Minhas Tasks</a></li>
        ...
        <section id="content" style="border: 2px solid #00e87b;border-radius: 0px 5px 5px 0px;margin-top: 40px;width: 70%;float: left;padding: 20px;">
            ...
            <table style='border: 2px solid #00e87b;padding: 20px;margin-top: 10px;width: 100%;'>
                <tr>
                    ...
                    <th style='border: 1px solid #00e87b;padding: 10px;'>Concluir</th>
                </tr>
                <?php
                    try {
                        ...
                        foreach ($lista as $value) {
                            ...
                            if ($value['concluida'] == 'false') {
                                echo "
                                <td style='border: 1px solid #00e87b;padding: 10px;'><a href='back-end/concluir.php?nome={$value['nome']}&desc={$value['descricao']}&data={$value['data_de_conclusao']}'><button style='background-color: #00e87b;padding: 10px;border: none;border-radius: 5px;color: white;cursor: pointer;'>Concluir</button></a></td>";
                            } else if ($value['concluida'] == 'true') {
                                echo "
                                <td style='border: 1px solid #00e87b;padding: 10px;'>Já concluida</td>";
                            }
                            echo "</tr>";
                        }
